...
class Threebody {
    ...
    constructor(position) {
        ...
        this.bodies[0].velocity = {x: -this.bodies[1].velocity.x/2, y: Math.random()*0.2-0.1}
        this.bodies[2].velocity = {x: -this.bodies[1].velocity.x/2, y: -this.bodies[0].velocity.y}
