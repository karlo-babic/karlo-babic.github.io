export const Console = {
    // --- Configuration ---
    availablePrograms: ['help', 'gameoflife', 'evoltree', 'mandelbrot', 'boids', 'gravitysim', 'glideroflife', 'gliderpong', 'eliza', 'img', 'sun', 'nasa', 'ip', 'stats', 'radio', 'read', 'txt', 'radar', 'chat', 'edit', 'store'],
